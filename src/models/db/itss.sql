...
ALTER TABLE room_equipment
ADD CONSTRAINT FK_room_equipment_equipmentId
...
INSERT INTO equipment (equipmentCategoryId, id, name, status, mfg, yearOfUse, numberOfRepairs, note)
VALUES
	(1,'MC001','MayChieu',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(2,'MMC001','ManMayChieu',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(4,'MT001','MayTinh',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(6,'B001','Ban',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(7,'G001','Ghe',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(3,'BD001','BangDen',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(5,'L001','Loa',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(8,'D001','Den',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(9,'KS001','KeSach',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(1,'MC002','MayChieu',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(2,'MMC002','ManMayChieu',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(4,'MT002','MayTinh',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(6,'B002','Ban',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(7,'G002','Ghe',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(3,'BD002','BangDen',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(5,'L002','Loa',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(8,'D002','Den',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(9,'KS002','KeSach',2,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(1,'MC003','MayChieu',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(2,'MMC003','ManMayChieu',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(4,'MT003','MayTinh',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(6,'B003','Ban',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(7,'G003','Ghe',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(3,'BD003','BangDen',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(5,'L003','Loa',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(8,'D003','Den',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(9,'KS003','KeSach',3,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(1,'MC004','MayChieu',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(2,'MMC004','ManMayChieu',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(4,'MT004','MayTinh',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(6,'B004','Ban',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(7,'G004','Ghe',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(3,'BD004','BangDen',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(5,'L004','Loa',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(8,'D004','Den',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(9,'KS004','KeSach',4,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(1,'MC005','MayChieu',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(2,'MMC005','ManMayChieu',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(4,'MT005','MayTinh',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(6,'B005','Ban',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(7,'G005','Ghe',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(3,'BD005','BangDen',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(5,'L005','Loa',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(8,'D005','Den',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(9,'KS005','KeSach',5,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(1,'MC006','MayChieu',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(2,'MMC006','ManMayChieu',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(4,'MT006','MayTinh',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(6,'B006','Ban',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(7,'G006','Ghe',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(3,'BD006','BangDen',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(5,'L006','Loa',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(8,'D006','Den',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(9,'KS006','KeSach',6,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(1,'MC007','MayChieu',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(2,'MMC007','ManMayChieu',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(4,'MT007','MayTinh',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(6,'B007','Ban',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(7,'G007','Ghe',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(3,'BD007','BangDen',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(5,'L007','Loa',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(8,'D007','Den',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(9,'KS007','KeSach',7,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(1,'MC008','MayChieu',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(2,'MMC008','ManMayChieu',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(4,'MT008','MayTinh',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(6,'B008','Ban',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(7,'G008','Ghe',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(3,'BD008','BangDen',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(5,'L008','Loa',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(8,'D008','Den',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(9,'KS008','KeSach',8,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(1,'MC009','MayChieu',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(2,'MMC009','ManMayChieu',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(4,'MT009','MayTinh',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(6,'B009','Ban',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 2'),
(7,'G009','Ghe',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(3,'BD009','BangDen',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(5,'L009','Loa',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 1'),
(8,'D009','Den',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0'),
(9,'KS009','KeSach',9,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),0,'Note 0');
...
(1,1,'varchar 1', CURRENT_TIMESTAMP(), 1, 2),
(2,2,'varchar 2', CURRENT_TIMESTAMP(), 2, 3),
(3,3,'varchar 3', CURRENT_TIMESTAMP(), 3, 4),
(4,4,'varchar 4', CURRENT_TIMESTAMP(), 4, 5),
(5,5,'varchar 5', CURRENT_TIMESTAMP(), 5, 6),
(6,6,'varchar 6', CURRENT_TIMESTAMP(), 6, 7),
(7,7,'varchar 7', CURRENT_TIMESTAMP(), 7, 8),
(8,8,'varchar 8', CURRENT_TIMESTAMP(), 8, 9),
(9,9,'varchar 9', CURRENT_TIMESTAMP(), 9, 10),
(10,10,'varchar 10', CURRENT_TIMESTAMP(), 10, 11),
(11,11,'varchar 11', CURRENT_TIMESTAMP(), 11, 12),
(12,12,'varchar 12', CURRENT_TIMESTAMP(), 12, 13),
(13,13,'varchar 13', CURRENT_TIMESTAMP(), 13, 14),
(14,14,'varchar 14', CURRENT_TIMESTAMP(), 14, 15),
(15,15,'varchar 15', CURRENT_TIMESTAMP(), 15, 16),
(16,16,'varchar 16', CURRENT_TIMESTAMP(), 16, 17),
(17,17,'varchar 17', CURRENT_TIMESTAMP(), 17, 18),
(18,18,'varchar 18', CURRENT_TIMESTAMP(), 18, 19),
(19,19,'varchar 19', CURRENT_TIMESTAMP(), 19, 20),
(20,20,'varchar 20', CURRENT_TIMESTAMP(), 20, 21),
(21,21,'varchar 21', CURRENT_TIMESTAMP(), 21, 22),
(22,22,'varchar 22', CURRENT_TIMESTAMP(), 22, 23),
(23,23,'varchar 23', CURRENT_TIMESTAMP(), 23, 24),
(24,24,'varchar 24', CURRENT_TIMESTAMP(), 24, 25),
(25,25,'varchar 25', CURRENT_TIMESTAMP(), 25, 26),
(26,26,'varchar 26', CURRENT_TIMESTAMP(), 26, 27),
(27,27,'varchar 27', CURRENT_TIMESTAMP(), 27, 28),
(28,28,'varchar 28', CURRENT_TIMESTAMP(), 28, 29),
(29,29,'varchar 29', CURRENT_TIMESTAMP(), 29, 30),
(30,30,'varchar 30', CURRENT_TIMESTAMP(), 30, 31),
(31,31,'varchar 31', CURRENT_TIMESTAMP(), 31, 32),
(32,32,'varchar 32', CURRENT_TIMESTAMP(), 32, 33),
(33,33,'varchar 33', CURRENT_TIMESTAMP(), 33, 34),
(34,34,'varchar 34', CURRENT_TIMESTAMP(), 34, 35),
(35,35,'varchar 35', CURRENT_TIMESTAMP(), 35, 36),
(36,36,'varchar 36', CURRENT_TIMESTAMP(), 36, 37),
(37,37,'varchar 37', CURRENT_TIMESTAMP(), 37, 38),
(38,38,'varchar 38', CURRENT_TIMESTAMP(), 38, 39),
(39,39,'varchar 39', CURRENT_TIMESTAMP(), 39, 40),
(40,40,'varchar 40', CURRENT_TIMESTAMP(), 40, 41),
(41,41,'varchar 41', CURRENT_TIMESTAMP(), 41, 42),
(42,42,'varchar 42', CURRENT_TIMESTAMP(), 42, 43),
(43,43,'varchar 43', CURRENT_TIMESTAMP(), 43, 44),
(44,44,'varchar 44', CURRENT_TIMESTAMP(), 44, 45),
(45,45,'varchar 45', CURRENT_TIMESTAMP(), 45, 46),
(46,46,'varchar 46', CURRENT_TIMESTAMP(), 46, 47),
(47,47,'varchar 47', CURRENT_TIMESTAMP(), 47, 48),
(48,48,'varchar 48', CURRENT_TIMESTAMP(), 48, 49),
(49,49,'varchar 49', CURRENT_TIMESTAMP(), 49, 50),
(50,50,'varchar 50', CURRENT_TIMESTAMP(), 50, 51),
(51,51,'varchar 51', CURRENT_TIMESTAMP(), 51, 52),
(52,52,'varchar 52', CURRENT_TIMESTAMP(), 52, 53),
(53,53,'varchar 53', CURRENT_TIMESTAMP(), 53, 54),
(54,54,'varchar 54', CURRENT_TIMESTAMP(), 54, 55),
(55,55,'varchar 55', CURRENT_TIMESTAMP(), 55, 56),
(56,56,'varchar 56', CURRENT_TIMESTAMP(), 56, 57),
(57,57,'varchar 57', CURRENT_TIMESTAMP(), 57, 58),
(58,58,'varchar 58', CURRENT_TIMESTAMP(), 58, 59),
(59,59,'varchar 59', CURRENT_TIMESTAMP(), 59, 60),
(60,60,'varchar 60', CURRENT_TIMESTAMP(), 60, 61),
(61,61,'varchar 61', CURRENT_TIMESTAMP(), 61, 62),
(62,62,'varchar 62', CURRENT_TIMESTAMP(), 62, 63),
(63,63,'varchar 63', CURRENT_TIMESTAMP(), 63, 64),
(64,64,'varchar 64', CURRENT_TIMESTAMP(), 64, 65),
(65,65,'varchar 65', CURRENT_TIMESTAMP(), 65, 66),
(66,66,'varchar 66', CURRENT_TIMESTAMP(), 66, 67),
(67,67,'varchar 67', CURRENT_TIMESTAMP(), 67, 68),
(68,68,'varchar 68', CURRENT_TIMESTAMP(), 68, 69),
(69,69,'varchar 69', CURRENT_TIMESTAMP(), 69, 70),
(70,70,'varchar 70', CURRENT_TIMESTAMP(), 70, 71),
(71,71,'varchar 71', CURRENT_TIMESTAMP(), 71, 72),
(72,72,'varchar 72', CURRENT_TIMESTAMP(), 72, 73),
(73,73,'varchar 73', CURRENT_TIMESTAMP(), 73, 74),
(74,74,'varchar 74', CURRENT_TIMESTAMP(), 74, 75),
(75,75,'varchar 75', CURRENT_TIMESTAMP(), 75, 76),
(76,76,'varchar 76', CURRENT_TIMESTAMP(), 76, 77),
(77,77,'varchar 77', CURRENT_TIMESTAMP(), 77, 78),
(87,87,'varchar 87', CURRENT_TIMESTAMP(), 87, 88),
(88,88,'varchar 88', CURRENT_TIMESTAMP(), 88, 89),
(89,89,'varchar 89', CURRENT_TIMESTAMP(), 89, 90),
(90,90,'varchar 90', CURRENT_TIMESTAMP(), 90, 91),
(91,91,'varchar 91', CURRENT_TIMESTAMP(), 91, 92),
(92,92,'varchar 92', CURRENT_TIMESTAMP(), 92, 93),
(93,93,'varchar 93', CURRENT_TIMESTAMP(), 93, 94),
(94,94,'varchar 94', CURRENT_TIMESTAMP(), 94, 95),
(95,95,'varchar 95', CURRENT_TIMESTAMP(), 95, 96),
(96,96,'varchar 96', CURRENT_TIMESTAMP(), 96, 97),
(97,97,'varchar 97', CURRENT_TIMESTAMP(), 97, 98),
(98,98,'varchar 98', CURRENT_TIMESTAMP(), 98, 99),
(99,99,'varchar 99', CURRENT_TIMESTAMP(), 99, 100);
